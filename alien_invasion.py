...
def run_game():
    ...
    while True:
        ...
        number_ship, ship = gf.update_ships(ai_settings, stats, screen, number_ship, ships, ship, aliens, bullets,
                                            alien_bullets, sb, explosions, air_bombs)
        ...
        gf.update_screen(ai_settings, screen, ship, aliens, bullets, stars, stats, play_button, about_it_button,
                         ...
                         explosions, air_bombs, alien_bullets, description_text_surfaces,
                         description_image_ships_surface, hint_for_exit_button, description_title_surface)
        #clock.tick(300)
